...
colnames(A_constr) = rownames(A_constr) = colnames(XX)
...
save(out_pooled, file ="data/out_breast_cancer_pooled.RData")
...
save(out_causal_pooled, file ="data/out_breast_cancer_pooled_causal.RData")
