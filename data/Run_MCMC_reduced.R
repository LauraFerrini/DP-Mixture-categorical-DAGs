...
save(out_mcmc, file = "data/out_breastcancer_reduced.RData")
...
load("data/out_breastcancer_reduced.RData")
...
pdf(file = "data/psm_reduced.pdf",   # The directory you want to save the file in
...
colori = colorRampPalette(c('white','black'))
pdf(file = "data/PPI_cl1_reduced.pdf",   # The directory you want to save the file in
...
pdf(file = "data/PPI_cl2_reduced.pdf",   # The directory you want to save the file in
    width = 9, # The width of the plot in inches
    height = 7.2) # The height of the plot in inches
par(oma = c(3,3,1,1.5), mar = c(5,4,0.3,1), mai = c(1,1,0.1,1))
...
pdf('data/spider_cl1_reduced.pdf', pointsize=10, width=9, height=9)
p = prop_all[1:2, ] %>%
...
p
dev.off()
pdf('data/spider_cl2_reduced.pdf', pointsize=10, width=9, height=9)
p = prop_all[c(1,3), ] %>%
  ggradar(group.line.width = 1,
...
save(res_AC, file ="data/AC_reduced.RData")
set.seed(123)
...
save(out_causal, file ="data/out_causal_reduced.RData")
...
load("data/out_breastcancer_reduced_pooled.RData")
...
load("data/out_causal_reduced.RData")
...
pdf(file = "data/AC_reduced.pdf",   # The directory you want to save the file in
...
pdf(file = "data/CE_antiHER2_reduced.pdf",   # The directory you want to save the file in
    width = 8.5, # The width of the plot in inches
    height = 7)
